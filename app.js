(() => {
  ...
  const NAV = [
    ...
    { label: "SQL", items: [
      ...
      { label: "Dashboards", icon: "ai-bi-dashboards", ids: ["ai-bi-dashboards", "lakeview-dashboards", "legacy-dashboards"] },
      { label: "Genie Agents", icon: "genie", ids: ["genie-agents", "genie-spaces", "genie-one", "databricks-one", "genie-code", "databricks-assistant"] },
