(() => {
  ...
  const NAV = [
    { label: "", items: [
      ...
      { label: "Workspace", icon: "workspace", ids: ["repos", "serverless-workspaces"] },
      { label: "Recents", icon: "recents" },
      { label: "Catalog", icon: "catalog", ids: ["catalog-explorer", "uc-volumes", "lakehouse-federation", "delta-sharing", "hive-metastore", "abac", "uc-managed-iceberg"] },
      { label: "Jobs & Pipelines", icon: "jobs", ids: ["dlt", "workflows", "bundles", "dbx", "pipelines-editor"] },
      { label: "Compute", icon: "compute", ids: ["lakebase"] },
