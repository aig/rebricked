...
| anything per-vendor: a `VALID_CATEGORIES` key, a `VENDOR_RAILS` rail, `SPA_VENDORS`, a new `kb/<vendor>/` | the Vendors section of [`AGENTS.md`](../AGENTS.md), [reference/entry-schema.md](reference/entry-schema.md), [reference/generated-output.md](reference/generated-output.md) |
